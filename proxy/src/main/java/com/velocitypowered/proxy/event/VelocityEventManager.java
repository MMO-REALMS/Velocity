...
//    System.out.println(handlersCache.handlers.length);
//    for (HandlerRegistration handler : handlersCache.handlers) {
//      System.out.println("[1] " + handler);
//      System.out.println("[2] " + handler.handler);
//      System.out.println("[3] " + handler.eventType);
//      System.out.println("[4] " + handler.plugin);
//      System.out.println();
//      System.out.println();
//    }
	...
	private <E> void fire(final @Nullable CompletableFuture<E> future,
		...
		if (event instanceof CommandExecuteEvent e) {
	...
	private <E> void fire(final @Nullable CompletableFuture<E> future, final E event,
		...
		if (event instanceof CommandExecuteEvent e) {
			System.out.println("[1] " + e.getResult());
			System.out.println("[2] " + e.getResult().isForwardToServer());
			System.out.println();
			System.out.println();
		}
		...
		for (int i = offset; i < registrations.length; i++) {
			...
			try {
				...
				if (eventTask == null) {
					if (event instanceof CommandExecuteEvent e) {
						System.out.println("[3.1] " + registration);
						System.out.println("[4.1] " + registration.handler);
						System.out.println("[5.1] " + registration.eventType);
						System.out.println("[6.1] " + registration.plugin);
						System.out.println("[7.1] " + e.getResult());
						System.out.println("[8.1] " + e.getResult().isForwardToServer());
						System.out.println();
						System.out.println();
					}
				...
				if (currentlyAsync || !eventTask.requiresAsync()) {
					if (continuationTask.execute()) {
						if (event instanceof CommandExecuteEvent e) {
							System.out.println("[3.2] " + registration);
							System.out.println("[4.2] " + registration.handler);
							System.out.println("[5.2] " + registration.eventType);
							System.out.println("[6.2] " + registration.plugin);
							System.out.println("[7.2] " + e.getResult());
							System.out.println("[8.2] " + e.getResult().isForwardToServer());
							System.out.println();
							System.out.println();
						}
				...
				if (event instanceof CommandExecuteEvent e) {
					System.out.println("[3.3] " + registration);
					System.out.println("[4.3] " + registration.handler);
					System.out.println("[5.3] " + registration.eventType);
					System.out.println("[6.3] " + registration.plugin);
					System.out.println("[7.3] " + e.getResult());
					System.out.println("[8.3] " + e.getResult().isForwardToServer());
					System.out.println();
					System.out.println();
				}
			...
			if (event instanceof CommandExecuteEvent e) {
				System.out.println("[3.4] " + registration);
				System.out.println("[4.4] " + registration.handler);
				System.out.println("[5.4] " + registration.eventType);
				System.out.println("[6.4] " + registration.plugin);
				System.out.println("[7.4] " + e.getResult());
				System.out.println("[8.4] " + e.getResult().isForwardToServer());
				System.out.println();
				System.out.println();
			}
